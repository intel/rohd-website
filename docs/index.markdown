...
feature_row2:
  - image_path: assets/images/gettyimages-847623056.jpg
    ...
    url: "https://intel.github.io/rohd-hcl/confapp/"
...
feature_row6:
  - image_path: assets/images/schematic-visualization.svg
    alt: "Angled schematic with glowing logic gates and signal connections"
    title: "ROHD Schematic Viewer"
    url: "https://intel.github.io/rohd-schematic-viewer/"
    btn_label: "<i class='fas fa-cloud'></i> Try it in-browser"
    btn_class: "btn--primary"
    excerpt: >
      <p>
        Explore generated hardware as an interactive schematic matching your ROHD RTL design. Browse module hierarchy, expand connected logic, and trace signals through your design.
      </p>
      <p>
        Open a Yosys JSON netlist format generated by ROHD directly in your browser with no installation or upload required. The Flutter-based viewer also supports native desktop and VS Code hosts, with source navigation and cross-probing in integrated environments.
      </p>
      <p style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
        <a href='https://github.com/intel/rohd-schematic-viewer' style="display: inline-flex; align-items: center; text-decoration: none; margin-top: -2px;">
          <i class='fab fa-fw fa-github'></i>View on GitHub
        </a>
